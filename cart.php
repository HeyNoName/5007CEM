    ...
    <div class="overflow-hidden">
        ...
        <div class="container">
            ...
            <div class="content" id="mobile-menu-button">
                ...
                ?>
                <div style="padding-left:3.9em; display:flex;" class="button pt-3">
                    <input type="button" value="Continuous Shopping" onclick="location.href = 'product.php'">&nbsp;&nbsp;&nbsp;
                    ...
                    <form method="post" action="payment.php">
                        ...
                        <input type="hidden" name="product_type[]" value="<?php echo $item['type']; ?>">
                        <input type="hidden" name="product_quantity[]" value="<?php echo $cart[$itemId]; ?>">
            ...
            <div class="content" id="menu">
                ...
                if (!empty($allProducts)) {
                    ...
                    foreach ($allProducts as $itemId => $item) {
                        ...
                        if (!array_key_exists('name', $item) || !array_key_exists('price', $item)) {
                            echo '<p>Error: Product data incomplete</p>';
                            continue;
                        }
                ...
                <input type="hidden" name="cart_data" value="<?php echo base64_encode(json_encode($allProducts)); ?>">
                <div style="padding-left:66.9em; display: flex;" class="button pt-3">
                    <input type="button" value="Continuous Shopping" onclick="location.href = 'product.php'">&nbsp;&nbsp;&nbsp;
                    <form method="post" action="payment.php">
                        <input type="hidden" name="total_price" value="<?php echo $totalPrice; ?>">
                        <?php
                        foreach ($allProducts as $itemId => $item) {
                            ...
                            echo '<input type="hidden" name="product_type[]" value="' . $item['type'] . '">';
                            echo '<input type="hidden" name="product_quantity[]" value="' . ($item['type'] === 'regular' ? $cart[$itemId] : $seasonalCart[$itemId]) . '">';
                        }
                        ?>
                        <input type="submit" value="Checkout">
                    </form>
